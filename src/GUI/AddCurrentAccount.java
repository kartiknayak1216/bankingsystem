...
import java.awt.Color; // Add this import for custom colors
...
public class AddCurrentAccount extends JFrame {
	...
	public AddCurrentAccount() {
		...
		contentPane.setBackground(Color.BLACK); // Set background color to black
		...
		lblAddCurrentAccount.setForeground(Color.WHITE); // Set text color to white
		lblAddCurrentAccount.setBounds(10, 11, 414, 34);
		contentPane.add(lblAddCurrentAccount);

		JLabel lblName = new JLabel("Name:");
		lblName.setFont(new Font("Tahoma", Font.PLAIN, 11));
		lblName.setForeground(Color.WHITE); // Set text color to white
		...
		lblBalance.setForeground(Color.WHITE); // Set text color to white
		...
		lblMaximumWithdrawLimit.setForeground(Color.WHITE); // Set text color to white
